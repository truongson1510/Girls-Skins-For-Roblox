...
public class Fader : MonoBehaviour
{
    ...
    public void InitiateFader(UnityAction actionComplete)
    {
        ...
        {
            myCanvas.alpha = 0.0f;
            StartCoroutine(FadeIt(actionComplete));
        }
        else
            Debug.LogWarning("Something is missing please reimport the package."); 
    }

    IEnumerator FadeIt(UnityAction actionComplete = null)
    {
